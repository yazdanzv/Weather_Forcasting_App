...
class Weather:
    def __init__(self):
        ...
        self.label_temp = Label(self.frame_today_info,
                                text="Temp : " + str(temp)[0:4] + "  feels like " + str(temp_feel)[0:4],
        ...
        self.label_time_1 = Label(self.frame_hourly_info_1,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][0]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_2 = Label(self.frame_hourly_info_2,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][1]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_3 = Label(self.frame_hourly_info_3,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][2]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_4 = Label(self.frame_hourly_info_4,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][3]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_5 = Label(self.frame_hourly_info_5,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][4]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_6 = Label(self.frame_hourly_info_6,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][5]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_7 = Label(self.frame_hourly_info_7,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][6]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_8 = Label(self.frame_hourly_info_8,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][7]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_9 = Label(self.frame_hourly_info_9,
                                  text=datetime.datetime.fromtimestamp(self.datas['hourly'][8]['dt']).strftime(
                                      "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                  fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_10 = Label(self.frame_hourly_info_10,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][9]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_11 = Label(self.frame_hourly_info_11,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][10]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_12 = Label(self.frame_hourly_info_12,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][11]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_13 = Label(self.frame_hourly_info_13,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][12]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_14 = Label(self.frame_hourly_info_14,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][13]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_15 = Label(self.frame_hourly_info_15,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][14]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_16 = Label(self.frame_hourly_info_16,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][15]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_17 = Label(self.frame_hourly_info_17,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][16]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_18 = Label(self.frame_hourly_info_18,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][17]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_19 = Label(self.frame_hourly_info_19,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][18]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_20 = Label(self.frame_hourly_info_20,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][19]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_21 = Label(self.frame_hourly_info_21,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][20]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_22 = Label(self.frame_hourly_info_22,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][21]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_23 = Label(self.frame_hourly_info_23,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][22]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        self.label_time_24 = Label(self.frame_hourly_info_24,
                                   text=datetime.datetime.fromtimestamp(self.datas['hourly'][23]['dt']).strftime(
                                       "%I:%M:%S"), font=("nk57-monospace", "8", "normal"),
                                   fg="white", bg=NAVY_BLUE, highlightthickness=0)
        # hourly temp
        ...
        self.canvas.create_text(235, 220, text=f"sunrise : {sunrise} AM / sunset : {sunset} PM", font=MONOFONT_NK57,
                                fill="white")
        self.canvas.create_text(192, 180, text=self.dt, font=MONOFONT_NK57, fill="white")
